...
fun Context.isWhiteTheme() = (baseConfig.textColor == DARK_GREY && baseConfig.primaryColor == Color.WHITE && baseConfig.backgroundColor == Color.WHITE) or (baseConfig.backgroundColor == Color.WHITE)
